...
#define INPUT_FILE_NAME         "../test-data/itu/fax/itu8.tif"
...
int main(int argc, char *argv[])
{
    ...
    if( receiver || sender) {
        ...
        if ((t38_state_a = t38_terminal_init(NULL, sender, tx_packet_handler_a, &sockfd)) == NULL)
        {
            fprintf(stderr, "Cannot start the T.38 channel\n");
            exit(2);
        }
        ...
        t30_get_transfer_statistics(fax_get_t30_state(t38_state_a), &t);
